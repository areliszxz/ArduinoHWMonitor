...
void loop(void) {
    ...
    if (Serial.available() > 0) { 
      ...
      //comentar w_time() para modificar gui sin ejecutar el enviador, y drawOLEDA(); para prod
      //drawOLEDA();
      w_time();
    }
      delay(500); 
...
/*Other SEC*/
  ...
  OLEDA.fillRoundRect(118, 90 ,100, 15, 0, ST77XX_BLACK);
  Serial.println(cputmp);
  OLEDA.print(cputmp); 
  ...
  OLEDA.fillRoundRect(118, 110 ,100, 15, 0, ST77XX_BLACK);
  Serial.println(gputmp);
  OLEDA.print(gputmp); 
  //
//END Other
}
